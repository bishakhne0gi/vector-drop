...
export const metadata: Metadata = {
  ...
  keywords: [
    // Head terms, ordered by validated Google Trends volume (12-month, worldwide).
    "png to svg",
    "image to vector",
    "svg converter",
    "image to svg",
    ...
    // Qualifier long-tails — lower competition, high intent.
    "png to svg free",
    "jpg to svg converter free",
    "best svg converter",
    "free svg converter",
    "online svg converter",
    "svg converter no watermark",
    // Informational cluster — rising, low competition.
    "png vs svg",
    "what is an svg file",
    "edit svg",
    "make svg background transparent",
    "reduce svg file size",
    // Craft, print, and fabrication intent.
    ...
    "adobe express svg converter",
    "recraft ai alternative",
