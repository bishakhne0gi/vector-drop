  ...
  return (
    ...
    >
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 16, color: "rgba(255,255,255,0.60)", margin: "0 0 48px", lineHeight: 1.6 }}>
          No subscription. No monthly minimum. Buy credits once and use them whenever —
          they never expire.
        </p>
        ...
        >
          ...
          <p style={{ fontSize: 14, color: "rgba(255,255,255,0.70)", margin: "0 0 24px", lineHeight: 1.7 }}>
        ...
        <dl style={{ margin: 0, fontSize: 14, lineHeight: 1.7 }}>
          ...
          <dd style={{ margin: "6px 0 0", color: "rgba(255,255,255,0.60)" }}>
            Never. Once you have exported a version, it is yours — any format, as many times
            as you like.
          </dd>

          <dt style={{ fontWeight: 600, marginTop: 20 }}>
            What if a conversion comes out badly?
          </dt>
          <dd style={{ margin: "6px 0 0", color: "rgba(255,255,255,0.60)" }}>
